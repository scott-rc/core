...
type Todo struct {
	...
	CompletedAt null.Time `boil:"completed_at" json:"completedAt,omitempty" toml:"completedAt" yaml:"completedAt,omitempty"`
...
var TodoWhere = struct {
	...
	CompletedAt: whereHelpernull_Time{field: "\"todos\".\"completed_at\""},
}
...
var (
	todoAllColumns            = []string{"todo_id", "user_id", "title", "created_at", "updated_at", "completed_at"}
	todoColumnsWithoutDefault = []string{"user_id", "title", "completed_at"}
	todoColumnsWithDefault    = []string{"todo_id", "created_at", "updated_at"}
