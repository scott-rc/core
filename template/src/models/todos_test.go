...
var (
	todoDBTypes = map[string]string{`TodoID`: `integer`, `UserID`: `integer`, `Title`: `text`, `CreatedAt`: `timestamp with time zone`, `UpdatedAt`: `timestamp with time zone`, `CompletedAt`: `timestamp with time zone`}
	_           = bytes.MinRead
)
